<form class="mt-4 publish-form" id="topic-form" action="{{ isset($isEdit) ? route('posts.post.edit', ['post' => $post->slug ]) : route('posts.post.new') }}" method="POST">
        ...
        <div class="uk-form-group">
            <div class="uk-position-relative">
                <input type="text" name="title" class="uk-input uk-form-large text-lg text-weight-bold text-dark" style="font-size: 24px;" autofocus="autofocus" placeholder="Title" value="{{ isset($isEdit) ? $post->title : '' }}" required>
            </div>
        </div>
            ...
            <!-- select2  -->
                <select class="uk-select uk-form-large" name="community" @if(isset($isEdit)) value="{{ $post->community_id }}" @endif >
        ...
        <div class="uk-form-group">
            <div class="uk-position-relative editor-container">
                <div class="editor" id="editor_topics"></div>
