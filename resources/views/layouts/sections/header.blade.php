            ...
            <header>
                <div class="header-innr">
                    ...
                    <div class="head_user">
                        ...
                        <a href="{{ route('community.all') }}" class="opts_icon_link uk-visible@s text-dark"> <i class="icon-feather-users"></i> Communities</a>
                        <a href="{{ route('jobs') }}" class="opts_icon_link uk-visible@s text-dark mr-2"> <i class="icon-feather-briefcase"></i> Jobs</a>
                        @if($user)
                        ...
                        <a href="{{ route('jobs') }}" class="opts_icon_link uk-hidden@s text-dark"> <i class="icon-feather-briefcase"></i></a>
