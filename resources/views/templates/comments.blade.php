                            ...
                            <div class="my-4">{!! $comment->comment !!}</div>
                                ...
                                <div class="row align-items-center border-top pt-3">
                                    ...
                                    <div class="col-sm-6 text-right">
                                        <a target="blank" title="Share on Facebook" href="https://www.facebook.com/sharer/sharer.php?u={{ route('posts.show', ['post' => $comment->slug]) }}#{{ $comment->id }}&utm_source=facebook" class="mr-2 text-gray">
                                            <i class="fa fa-facebook"></i>
                                        </a>
                                        <a target="blank" title="Share on Twitter" href="http://twitter.com/share?text={{ $comment->title }}&url=https://www.facebook.com/sharer/sharer.php?u={{ route('posts.show', ['post' => $comment->slug]) }}#{{ $comment->id }}&utm_source=twitter" class="mr-2 text-gray">
