...
InlineEditor.create(document.querySelector('.editor'), {
  toolbar: {
    items: ['heading', '|', 'bold', 'italic', 'underline', 'alignment', 'bulletedList', 'numberedList', '|', 'link', 'blockQuote', 'imageUpload', 'mediaEmbed', 'code', '|', 'undo', 'redo']
  },
  simpleUpload: {
...
function getFeedItems(queryText) {
  return new Promise(function (resolve) {
    $.get('users/list/?username=' + queryText, function (data) {
      var itemsToDisplay = JSON.parse(data);
...
/***/ 0:
/*!*********************************************!*\
  !*** multi ./resources/assets/js/editor.js ***!
  \*********************************************/
/*! no static exports found */
